...
// Fetch total articles (both admin and editor can see)
...
<div class="container py-5">
    ...
    <div class="mt-5">
        ...
        <a href="/Mindanow/admin/articles/create.php" class="btn btn-dark btn-sm me-2">
            Add Article
        </a>

        <a href="/Mindanow/public/index.php" target="_blank" class="btn btn-outline-secondary btn-sm me-2">
            View Website
        </a>

        <a href="/Mindanow/admin/logout.php" class="btn btn-outline-danger btn-sm">
            Logout
        </a>
    </div>
