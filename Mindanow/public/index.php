...
<img src="/Mindanow/uploads/articles/<?php echo htmlspecialchars($row['header_image']); ?>" class="card-img-top">
<?php else: ?>
...
<a href="article.php?id=<?php echo $row['id']; ?>" class="btn btn-read mt-auto">
Read More
</a>
...
<h3 class="mb-4 fw-bold text-success">Mindanao Cuisines</h3>

<div class="row g-4">

<?php
$result = $conn->query("SELECT * FROM cuisines ORDER BY created_at DESC LIMIT 6");
...
<?php if(!empty($row['header_image'])): ?>
<img src="/Mindanow/uploads/cuisines/<?php echo $row['image']; ?>" class="card-img-top">
<?php else: ?>
<img src="https://picsum.photos/600/400?food=<?php echo $row['id']; ?>" class="card-img-top">
<?php endif; ?>
...
<a href="cuisines.php?id=<?php echo $row['id']; ?>" class="btn btn-read mt-auto">
View Dish
</a>
...
<p>No cuisine articles available.</p>
...
<h3 class="mb-4 fw-bold text-success">Latest Announcements</h3>

<div class="row g-4">

<?php
$result = $conn->query("SELECT * FROM announcements ORDER BY created_at DESC LIMIT 6");
...
<a href="announcements.php?id=<?php echo $row['id']; ?>" class="btn btn-read mt-auto">
Read Announcement
</a>
